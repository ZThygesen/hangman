...
const wordArea = document.querySelector('.current-word');
function playGame() {
    word = getWord();
    generateLetters();
}
...
let updateMessage = document.querySelector('.game-update > p');
...
function handleInput() {
    ...
    if (gameOver) {
        console.log('here');
        const messageArea = document.querySelector('.game-update');
...
const incorrectArea = document.querySelector('.incorrect-letters');
